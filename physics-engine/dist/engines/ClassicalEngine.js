...
export class ClassicalEngine {
    ...
    createShape(shapeConfig) {
        switch (shapeConfig.type) {
            ...
            case 'box':
                return new CANNON.Box(new CANNON.Vec3(shapeConfig.width / 2, shapeConfig.height / 2, shapeConfig.depth / 2));
            case 'cylinder':
                return new CANNON.Cylinder(shapeConfig.radiusTop, shapeConfig.radiusBottom, shapeConfig.height, shapeConfig.segments);
            default:
