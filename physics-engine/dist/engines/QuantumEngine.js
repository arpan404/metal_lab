...
export class QuantumEngine {
    ...
    async computeWaveEvolution(waveData, params) {
        ...
        passEncoder.dispatchWorkgroups(Math.ceil(params.gridSize / 8), Math.ceil(params.gridSize / 8));
        passEncoder.end();
        ...
        commandEncoder.copyBufferToBuffer(outputBuffer, 0, readBuffer, 0, waveData.byteLength);
