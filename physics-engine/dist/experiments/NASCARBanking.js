...
export class NASCARBanking extends BaseExperiment {
    constructor() {
        ...
        super('NASCAR Banking', 'Explore how banked turns allow race cars to maintain high speeds', parameters, objectives);
        this.carId = 'car';
        this.trackRadius = 200; // meters
        this.bankAngle = 33; // degrees
        this.velocity = 50; // m/s
        this.currentAngle = 0; // radians around track
        this.lapCount = 0;
