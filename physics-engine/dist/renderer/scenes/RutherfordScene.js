...
export class RutherfordScene extends BaseScene {
    ...
    update(deltaTime) {
        ...
        particles.forEach(particleData => {
            ...
            // Update position
            particle.position.set(particleData.position.x * 10, // Scale for visibility
            particleData.position.y * 10, particleData.position.z * 10);
            // Update trail
            ...
            if (trail) {
                ...
                if (positions) {
                    ...
                    trail.geometry.setAttribute('position', new THREE.BufferAttribute(new Float32Array([
                        particle.position.x,
                        particle.position.y,
                        particle.position.z
                    ]), 3));
