 ...
 */
export async function checkMetalSupport(): Promise<boolean> {
  if (!navigator.gpu) {
    return false;
  }
 ...
 */
export async function getMetalCapabilities(): Promise<MetalCapabilities> {
  const capabilities: MetalCapabilities = {
 ...
 */
export async function initializeMetalGPU(): Promise<GPUDevice | null> {
  if (!navigator.gpu) {
 ...
 */
export async function loadMetalShader(
  device: GPUDevice,
  shaderSource: string,
  label?: string
 ...
 */
export async function createMetalComputePipeline(
  device: GPUDevice,
 ...
 */
export function getMetalWorkgroupSize(
  device: GPUDevice,
  totalThreads: number,
 ...
 */
export function createMetalBuffer(
  device: GPUDevice,
 ...
 */
export function dispatchMetalCompute(
  device: GPUDevice,
  pipeline: GPUComputePipeline,
  bindGroup: GPUBindGroup,
  totalThreads: number,
  preferredWorkgroupSize: number = 256
): void {
 ...
 */
export function checkMPSSupport(): boolean {
 ...
 */
export async function getMetalPerformanceHints(): Promise<{
 ...
 */
export async function logMetalInfo(): Promise<void> {
