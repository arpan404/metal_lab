...
export const FOUCAULT_EXPLANATION_POINTS: ExplanationPoint[] = [
  {
    id: 'foucault-intro',
    type: 'concept',
    priority: 'high',
...
export const NASCAR_EXPLANATION_POINTS: ExplanationPoint[] = [
  {
    id: 'nascar-intro',
    type: 'concept',
    priority: 'high',
...
export const MILLIKAN_EXPLANATION_POINTS: ExplanationPoint[] = [
  {
    id: 'millikan-intro',
    type: 'concept',
    priority: 'high',
...
export const DOUBLE_SLIT_EXPLANATION_POINTS: ExplanationPoint[] = [
  {
    id: 'doubleslit-intro',
    type: 'concept',
    priority: 'high',
...
export const RUTHERFORD_EXPLANATION_POINTS: ExplanationPoint[] = [
  {
    id: 'rutherford-intro',
    type: 'concept',
    priority: 'high',
 ...
 */
export function getExplanationPointsForExperiment(experimentName: string): ExplanationPoint[] {
 ...
 */
export function createExplanationPoint(
  id: string,
